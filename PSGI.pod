...
The header B<MUST NOT> contain a key named C<Status>, or any keys with C<:>
...
There B<MUST> be a C<Content-Type> header except when the C<Status> is 1xx, 204
or 304, in which case there B<MUST NOT> be a C<Content-Type> header.
